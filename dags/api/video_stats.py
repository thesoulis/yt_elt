...
def extract_video_data(video_ids):
    ...
    try:
        for batch in batch_list(video_ids,max_results):
            ...
            url=f'https://youtube.googleapis.com/youtube/v3/videos?part=contentDetails&part=snippet&part=statistics&id={video_ids_string}&key={YOUR_API_KEY}'
...
def save_to_json(extracted_date):
    ...
    with open(file_path,"w",encoding="utf-8") as json_file:
        json.dump(extracted_date,json_file,indent=4, ensure_ascii=False)
